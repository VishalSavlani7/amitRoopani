...
const Textbooks = () => {
  ...
  const SHEET_ID = "1fJzr4PMWbCuikywwonQdXs5_KgIm-fw23yGRgCisEWc";
      ...
      <section className="page-section">
        <div className="container mx-auto">
          <div className="mb-10">
            ...
            <h1 className="section-title mt-2">Textbook</h1>
            <p className="section-subtitle">Follow the steps below to find your Textbook.</p>
          </div>
            ...
            <div className="mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-heading font-semibold text-lg text-foreground">
                  Textbook{filteredNotes?.length !== 1 && "s"} 
